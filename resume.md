...
- **F Medical Care** *IT Department Intern*: Conducted testing and documentation for the qualification document system.
- **B Corporation** *IT Solutions Department Intern*: Assisted in implementing enterprise-level IT solutions. 
...
- **Conducted data cleaning and analysis using R for a class project**
- **Built visualizations to communicate trends and patterns**
- **Contributed to a team-based research project from data collection to presentation**
